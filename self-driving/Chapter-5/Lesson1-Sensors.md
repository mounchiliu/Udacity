...
**Note: KF精髓在于Kalman gain. Kalman gain本质上是weighted average 的 weight。你越相信你的prediction，prediction的uncertainty越小，observation的weight就越小；反之，你越不相信你的prediction，其uncertainty越大，相反observation的weight越大。**

- Kalman Filter Summary with simple example (use location & velocity as estimated states **1D Kalman filter**)
